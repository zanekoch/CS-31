...
int main()
{
	in surveyParticipants; //this throws a compile error because the variable surveyParticipants is not initialized so there are undeclared identifiers later
	int preferDogs;
	int preferCats;
	...
	return(0) //this throws an error because there is a missing ;
